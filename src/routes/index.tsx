...
const works = [
  {
    ...
    c: "AI · SaaS",
    pain: "Support team buried under 12,000 weekly tickets with reply times stretching past 36 hours and CSAT in free-fall.",
    fix: "Engineered a multi-tenant LLM agent with RAG over their knowledge base — autonomously resolves 78% of tickets in under 4 seconds.",
    tag: "AI",
  },
  {
    t: "Northwind Commerce",
    c: "Shopify · Plus",
    pain: "Legacy theme strangled mobile performance; 71% of checkouts abandoned before payment, costing six figures monthly.",
    fix: "Re-platformed onto headless Shopify with a one-page checkout and edge-rendered PDPs — conversion lifted 47% in 90 days.",
    tag: "Shopify",
  },
  {
    t: "Pulse Ops Engine",
    c: "Automation",
    pain: "Operations bleeding hours stitching four disconnected SaaS tools together with manual copy-paste every shift.",
    fix: "Consolidated the entire workflow into a single n8n pipeline with audit logging — $180k/yr recovered, zero manual entry.",
    tag: "Automation",
  },
  {
    t: "Atlas Field App",
    c: "Mobile · iOS / Android",
    pain: "1,200 field engineers losing critical inspection data the moment cellular signal dropped on remote sites.",
    fix: "Shipped an offline-first React Native app with conflict-free sync — 4.8★ store rating within six months of launch.",
    tag: "App",
  },
  {
    t: "Rahman Textiles Portal",
    c: "Full Stack · ERP",
    pain: "Order tracking scattered across WhatsApp threads and Excel sheets; nothing reconciled at month-end close.",
    fix: "Built a bespoke production portal with live shop-floor tracking and GST-ready invoicing — books close in 2 days, not 2 weeks.",
    tag: "Full Stack",
  },
  {
    t: "Bengal Foods Storefront",
    c: "WordPress · WooCommerce",
    pain: "Site loading in 8+ seconds; Google Ads spend burning out on traffic that bounced before the hero rendered.",
    fix: "Re-engineered on a performance-tuned WordPress stack with edge caching — 1.4s LCP, ROAS climbed 2.3x.",
    tag: "WordPress",
  },
  {
    t: "Sentinel AI Underwriter",
    c: "AI · FinTech",
    pain: "Credit analysts spending 6+ hours per file manually cross-referencing statements, KYC documents, and risk policies.",
    fix: "Deployed a fine-tuned LLM with policy-grounded RAG and explainable scoring — decisioning compressed from hours to under 4 minutes.",
    tag: "AI",
  },
  {
    t: "Aarong Voice Concierge",
    c: "AI · Retail",
    pain: "Call centre missing 40% of after-hours product enquiries and losing high-intent buyers to silence.",
    fix: "Launched a multilingual RAG voice agent that books appointments and answers SKU queries 24/7 — recovered revenue inside 30 days.",
    tag: "AI",
  },
  {
    t: "Indigo Mart Spam Shield",
    c: "Automation · Email",
    pain: "Marketing blasts landing in spam folders; deliverability collapsing and warm leads going cold overnight.",
    fix: "Built a bulk spam-free automation with domain warm-up, content scoring, and inbox-placement telemetry — deliverability stabilized above 96%.",
    tag: "Automation",
  },
  {
    t: "Crest LinkedIn Engine",
    c: "Automation · Social",
    pain: "Founder posting inconsistently on LinkedIn; pipeline drying up between sales sprints.",
    fix: "Architected end-to-end LinkedIn post automation with AI drafting, brand-voice tuning, and scheduled publishing — inbound demos tripled in a quarter.",
    tag: "Automation",
  },
  {
    t: "Lumen & Co. Marketplace",
    c: "Full Stack · E-Commerce",
    pain: "Off-the-shelf platform throttling SKU growth, fragmenting inventory, and bottlenecking promotions during peak sale events.",
    fix: "Engineered a custom React + Node commerce platform with real-time inventory, a modular promotions engine, and Stripe-native checkout — GMV up 2.6x YoY.",
    tag: "Full Stack",
  },
  {
    t: "Crestline Apparel · Shopify",
    c: "Shopify · DTC",
    pain: "Slow Liquid theme tanking Core Web Vitals; paid traffic bouncing before product imagery loaded.",
    fix: "Rebuilt on a conversion-tuned Shopify 2.0 theme with predictive search and bundled upsells — AOV up 32%, mobile LCP under 1.6s.",
    tag: "Shopify",
  },
];
